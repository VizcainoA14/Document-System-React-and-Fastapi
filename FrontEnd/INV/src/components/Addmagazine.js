...
export default function Addmagazine() {
    ...
    const [edition, setParam9] = useState('');
    const [pages, setParam10] = useState('');
    ...
    const handleSubmit = (event) => {
        ...
        fetch(`http://127.0.0.1:8000/api/document/ElectronicDoc/Add/Magazine/${author}/${title}/${price}/${topic}/${language}/${pub_date}/${size}/${doi}/${edition}/${pages}`, {method: 'POST'})
    ...
    return (
        <div className='Form'>
            ...
            <aside><Delete data="Magazines"/></aside>
        </div>
    )
}
